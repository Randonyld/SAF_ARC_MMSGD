...
text(-1.4, 1.1, '({\bf\itb})', 'fontsize', 18);
...
%% Save
emf_safarcmmsgd10 = emf;
save safarcmmsgd10.mat emf_safarcmmsgd10 msgd_mean msgd_std

if ntrial == 1
    wmsgd = w;
    qxmsgd = xx;
    qymsgd = yy;
    save msgd.mat wmsgd qxmsgd qymsgd w0 xx0 yy0
end