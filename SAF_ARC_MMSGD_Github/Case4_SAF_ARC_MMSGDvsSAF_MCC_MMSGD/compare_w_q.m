...
f1 = plot(wmcc, 'b-o', 'linewidth', 2, 'markersize', 8);
f2 = plot(wmsgd, 'r-s', 'linewidth', 2, 'markersize', 8);
f3 = plot(w0, 'g--', 'linewidth', 2);
...
figure; grid on; hold on; box on;
set(gca, 'fontweight', 'bold', 'FontSize', 15);
f1 = plot(qxmcc, qymcc, 'b-o', 'linewidth', 2, 'markersize', 8);
f2 = plot(qxmsgd, qymsgd, 'r-s', 'linewidth', 2, 'markersize', 8);
f3 = plot(xx0, yy0, 'g--', 'linewidth', 2);
