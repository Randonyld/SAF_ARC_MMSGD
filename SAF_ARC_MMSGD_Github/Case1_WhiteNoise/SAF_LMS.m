...
%     textprogressbar('      Sub processing.  ');
    for n = M:N
...
%         end
        ...
        w = w + rate_w*e(n)/dx*dU'*C*Qi*Xn; % update w
        qy(ind-1:ind+2) = qy(ind-1:ind+2) + rate_q*e(n)*C'*U; % update qy
    end
%     textprogressbar(100);
...
disp('>>> SAF-LMS algorithm end.');
%% Save
emf_saflms = emf;
save saflms.mat emf_saflms lms_mean lms_std